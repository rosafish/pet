...
--wandb_run_name ${MSG} \
--save_train_logits \
--train_custom_expl_file /data/shared/data/e-SNLI/dataset/esnli_train_1_100_ground_truth.jsonl \
--dev_custom_expl_file /data/shared/data/e-SNLI/dataset/esnli_dev_ground_truth.jsonl \
--beta 1.0